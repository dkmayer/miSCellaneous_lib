...
Fb1 : UGen {
	...
	*new { |func, in, outSize = 0, inDepth = 1, outDepth = 2, inInit, outInit,
		...
		var inSize, inBufsTemp, inBufs, outBufs, iteratedOut, outType,
			...
			blockCount, bufOffset, fbInSig, fbOutSig, outSig, doThis, orderSym;
		...
		{ (graphOrderType == 1) or: { graphOrderType == 2 } }{
			...
			outSig = BufRd.ar(1, shapeSig.(outBufs, outSize) <! doThis, Phasor.ar(0, 1, 0, bufSize));
		}
		{ graphOrderType == 0 }{
